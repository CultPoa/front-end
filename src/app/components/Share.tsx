      ...
      <div className="p-4 space-y-6">
        <div className="bg-gradient-to-br from-[#E63946] to-[#F4A261] rounded-2xl p-6 text-white">
          ...
          <p className="text-sm opacity-90">
            Tire uma foto do local que visitou e compartilhe nas redes sociais com #cultpoa
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-[#2A9D8F]/10 border border-[#2A9D8F]/30 rounded-xl p-4">
            ...
            <p className="text-sm text-gray-700">
              Use sempre a hashtag <span className="text-[#E63946]">#cultpoa</span> para fazer parte da comunidade e aparecer no feed oficial do aplicativo!
            </p>
          </div>
        </div>
      </div>
